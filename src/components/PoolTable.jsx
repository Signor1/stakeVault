                        ...
                        data.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className="flex flex-col gap-2 justify-center items-center border border-slate-700 p-3 text-center">
                                    ...
                                    <Dialog.Root>
                                        <Dialog.Trigger>
                                            <button className="bg-blue-500 flex items-center gap-1 text-sm px-6 py-1.5 rounded text-slate-100">Stake
                                            </button>
                                        ...
                                        <Dialog.Content style={{ maxWidth: 450 }}>
                                            ...
                                            <Flex gap="3" mt="4" justify="end">
                                                ...
                                                <Dialog.Close>
                                                    <button onClick={() => handleStake(item.index)} className="bg-blue-500 text-sm px-6 py-1.5 rounded text-slate-100">Stake</button>
                                                </Dialog.Close>
                                            </Flex>
                                        </Dialog.Content>
                                    </Dialog.Root>
